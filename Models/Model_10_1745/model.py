...
history = regressor.fit(x_train, y_train, epochs = EPOCH, batch_size=2048, validation_data=(x_test, y_test))
...
bm.save_est_plot(predictions,'Estimations')