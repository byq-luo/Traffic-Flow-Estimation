...
data = bm.merge_two_sensor_data(data_prev, data)
data_prev_two = data.shift(7*24*12*2)
data = bm.merge_two_sensor_data(data_prev_two, data)
...
bm.save_val_loss_plot(history, "validation_loss_graph.png")
